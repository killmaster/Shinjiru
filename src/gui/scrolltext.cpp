...
void ScrollText::paintEvent(QPaintEvent *e) {
  Q_UNUSED(e)
  QPainter p(this);
...
void ScrollText::resizeEvent(QResizeEvent *e) {
  Q_UNUSED(e)
  ...
  if (width() > 64) {
    ...
    for (int y = 1; y < height(); ++y)
      memcpy(alphaChannel.scanLine(y), reinterpret_cast<uchar *>(scanline1),
             width() * 4);
  } else {
